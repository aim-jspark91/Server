...
public class RecipeParameter extends UdfAccessor {
	...
	@CTORMTemplate(seq = "17", name="resetActiveFlag", type="Column", dataType="String", initial="", history="")
	private String resetActiveFlag;
	...
	public RecipeParameter(String machineName, String recipeName,
	...
	public String getResetActiveFlag() {
		return resetActiveFlag;
	}

	public void setResetActiveFlag(String resetActiveFlag) {
		this.resetActiveFlag = resetActiveFlag;
	}
