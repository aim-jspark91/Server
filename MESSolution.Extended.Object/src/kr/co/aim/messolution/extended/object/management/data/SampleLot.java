...
public class SampleLot extends UdfAccessor {
	...
	@CTORMTemplate(seq = "12", name = "fromProcessOperationName", type = "Key", dataType = "String", initial = "", history = "")
	private String fromProcessOperationName;
	
	@CTORMTemplate(seq = "13", name = "fromProcessOperationVersion", type = "Key", dataType = "String", initial = "", history = "")
	...
	@CTORMTemplate(seq = "31", name = "sampleDepartmentName", type = "Column", dataType = "String", initial = "", history = "")
	private String sampleDepartmentName;
	
	@CTORMTemplate(seq = "32", name = "holdDepartmentName", type = "Column", dataType = "String", initial = "", history = "")
	private String holdDepartmentName;
	...
	public SampleLot(String lotName, String factoryName,
			...
			String fromProcessOperationName, String fromProcessOperationVersion) {
		super();
	...
	public String getHoldDepartmentName() {
		return holdDepartmentName;
	}

	public void setHoldDepartmentName(String holdDepartmentName) {
		this.holdDepartmentName = holdDepartmentName;
	}
