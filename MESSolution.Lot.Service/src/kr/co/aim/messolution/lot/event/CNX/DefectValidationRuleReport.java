...
public class DefectValidationRuleReport extends AsyncHandler { 
	
	@Override 
	public void doWorks(Document doc) throws CustomException {
		
		 SMessageUtil.setHeaderItemValue(doc, "MESSAGENAME", "DefectValidationRuleReport");
	...
	private void generateBodyTemplate(Document doc) throws CustomException
	{
		...
		try {
			...
			for(DefectRuleSetting defectRuleSetting : defectRuleSettingList)
			{
				...
				mailFlag.setText(  defectRuleSetting.getHoldFlag()   );
