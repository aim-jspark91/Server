...
public class SorterJobAborted extends AsyncHandler {
		...
		throws CustomException  
	{
		...
		/* 20190125, hhlee, add, This SorterJob checks whether all jobs ended or not. ==>> */
        ...
        /* <<== 20181120, 20190125, add, This SorterJob checks whether all jobs ended or not. */
        
        /* 20190125, hhlee, add, This SorterJob checks whether all jobs ended or not. */
        if(sortJobCarrier == null)
        {
            /* 20190130, hhlee, add, check logic */
            if(!StringUtil.equals(sortJob.getJobState(), GenericServiceProxy.getConstantMap().SORT_JOBSTATE_ABORT))
            {
