...
public class CreateDefectRuleSetting extends SyncHandler
{
	@Override
	public Object doWorks(Document doc) throws CustomException 
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CreatedefectRuleSetting", this.getEventUser(), this.getEventComment(), "", "");
		...
		defectRuleSetting = new DefectRuleSetting(factoryName,productSpecName, productSpecVersion, processOperationName  , processOperationVersion,defectCode);
		...
		ExtendedObjectProxy.getDefectRuleSettingService().create(eventInfo, defectRuleSetting);
