...
public class BatchReserveFutureAction extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("FutureBHold", this.getEventUser(), note, "", "");
		...
		for (Element eledur : futureActionElementList)
		{
			...
			String department = SMessageUtil.getChildText(eledur, "DEPARTMENT", false);
