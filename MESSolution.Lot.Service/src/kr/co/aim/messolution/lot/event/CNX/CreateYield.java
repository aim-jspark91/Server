...
public class CreateYield extends SyncHandler
{
	@Override
	public Object doWorks(Document doc) throws CustomException 
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CreateYield", this.getEventUser(), this.getEventComment(), "", "");
		...
		yieldInfo = new YieldInfo(productSpecName, ecCode, processFlowName  , processFlowVersion  , processOperationName);
		...
		ExtendedObjectProxy.getYieldInfoService().create(eventInfo, yieldInfo);
