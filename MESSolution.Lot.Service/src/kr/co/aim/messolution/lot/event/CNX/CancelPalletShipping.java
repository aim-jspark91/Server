...
public class CancelPalletShipping extends SyncHandler {

	@Override
	public Object doWorks(Document doc) throws CustomException {
		
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CancelPalletShipping", getEventUser(), getEventComment(), "", "");
