...
public class ModifyAfterActionSetting extends SyncHandler
{
	@Override
	public Object doWorks(Document doc) throws CustomException 
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ModifyAfterActionSetting", this.getEventUser(), this.getEventComment(), "", "");
		...
		ExtendedObjectProxy.getAfterActionService().modify(eventInfo, afterAction);
