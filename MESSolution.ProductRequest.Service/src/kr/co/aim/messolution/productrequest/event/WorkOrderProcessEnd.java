...
public class WorkOrderProcessEnd extends AsyncHandler {
		...
		throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("Completing", getEventUser(), getEventComment(), null, null);
		pPlan.setProductRequestPlanState("Completing");
