...
public class HoldProbeCard extends SyncHandler {
	@Override
	public Object doWorks(Document doc) throws CustomException {
		Element eleBody = SMessageUtil.getBodyElement(doc);
		if (eleBody != null) {
			for (Element eleDurable : SMessageUtil.getBodySequenceItemList(doc, "PROBELIST", false)){
				// parsing
				...
				if(StringUtil.equals(durableData.getUdfs().get("DURABLEHOLDSTATE"), "Y"))
					throw new CustomException("PROBE-0004", sDurableName);
