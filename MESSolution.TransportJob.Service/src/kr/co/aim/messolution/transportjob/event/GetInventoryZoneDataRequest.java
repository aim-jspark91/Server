...
public class GetInventoryZoneDataRequest extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException {
		try {
			// Deleted by smkang on 2018.05.04 - If any event is not written, it would not be necessary to be made EventInfo.
//			EventInfo eventInfo = EventInfoUtil.makeEventInfo("GetInventoryZoneDataRequest", getEventUser(), getEventComment(), "", "");
//			eventInfo.setEventTimeKey(TimeUtils.getEventTimeKeyFromTimestamp(eventInfo.getEventTime()));
			...
			// Modified by smkang on 2018.04.14 - Request message should be sent using sendBySender method.
