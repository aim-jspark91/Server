...
public class HoldMaterial extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		/*============= Set event =============*/
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("Hold", getEventUser(), getEventComment(), reasonCodeType, reasonCode);
		...
		if (materialList != null)
		{
			for(Element materialE : materialList)
			{
				...
				String materialHoldState = SMessageUtil.getChildText(materialE, "MATERIALHOLDSTATE", false);
				
				/*============= Validation consumableHoldState =============*/
				if (materialHoldState.equals("Y"))
				{
