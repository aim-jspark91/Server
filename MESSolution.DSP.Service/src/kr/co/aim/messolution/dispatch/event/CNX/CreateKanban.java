...
public class CreateKanban extends SyncHandler
{
	@Override
	public Object doWorks(Document doc) throws CustomException 
	{
		...
		List<String> lstName = NameServiceProxy.getNameGeneratorRuleDefService().generateName("DSPStockerKanbanNaming", argSeq, 1);
		String kanbanName = lstName.get(0);
		...
		ExtendedObjectProxy.getDspStockerKanbanService().create(eventInfo, stockerKanbanData);
