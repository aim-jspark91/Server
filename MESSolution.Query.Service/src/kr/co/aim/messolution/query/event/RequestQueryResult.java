...
public class RequestQueryResult extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		String result = "";
		try {
			result = MESQueryServiceProxy.getQueryServiceImpl().getRequestQueryResult(messageName, sourceSubjectName, sourceSubjectName, transactionId, queryId, version, conditionElement, bindElement);
		} catch (Exception e) {
