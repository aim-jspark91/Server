...
public class CreateSendBack extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		String SendBackQty 	= SMessageUtil.getBodyItemValue(doc, "SENDBACKQUANTITY", true);
		...
		requestData.setRequestQuantity(SendBackQty);
