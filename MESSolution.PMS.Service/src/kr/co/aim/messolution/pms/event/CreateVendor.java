...
public class CreateVendor extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo  = EventInfoUtil.makeEventInfo("CreateVendor", getEventUser(), getEventComment(), null, null);
		...
		try
		{
			vendorInfo = PMSServiceProxy.getVendorService().create(eventInfo, vendorInfo);
		}
		catch(Exception ex)
		{
			throw new CustomException("PMS-0074", vendorID);
		}		
		return doc;
	}
}
