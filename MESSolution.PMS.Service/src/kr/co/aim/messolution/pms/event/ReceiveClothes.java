...
public class ReceiveClothes extends SyncHandler
{
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		eventInfo.setEventName("receiveClothes");
		...
		//check clean State  
		//2016-01-04 MODIFYTO received
		if(StringUtils.equals(clothesInfo.getCleanState(), "received"))
		{
			throw new CustomException("PMS-9001","received");
		}
		clothesInfo.setLastCleanTime(clothesInfo.getCurrentCleanTime());
		clothesInfo.setCurrentCleanTime(eventInfo.getEventTime());
		clothesInfo.setCleanState("received");
