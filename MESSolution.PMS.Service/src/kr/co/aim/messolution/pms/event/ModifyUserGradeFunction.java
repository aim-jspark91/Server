...
public class ModifyUserGradeFunction extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo  = EventInfoUtil.makeEventInfo("ModifyUserGradeFunction", getEventUser(), getEventComment(), null, null);
