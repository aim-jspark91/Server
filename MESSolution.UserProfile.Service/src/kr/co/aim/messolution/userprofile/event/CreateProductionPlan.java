...
public class CreateProductionPlan extends SyncHandler {
		...
		public Object doWorks(Document doc) throws CustomException {
			...
			try
			{
				EventInfo eventInfo = EventInfoUtil.makeEventInfo("CreateProductionPlan", getEventUser(), getEventComment(), null, null);
				...
				ExtendedObjectProxy.getProductionPlanService().create(eventInfo,productionPlanData);
