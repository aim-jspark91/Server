...
public class ModifyPlanQuantity  extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		try
		{
			EventInfo eventInfo = EventInfoUtil.makeEventInfo("ModifyPlanQuantity", getEventUser(), getEventComment(), null, null);
			...
			ExtendedObjectProxy.getPlanQuantityService().modify(eventInfo, quantityPlan);
		}
		catch(Exception ex)
		{
