...
public class ErrorMessageAlarm extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		String errorMessage = SMessageUtil.getBodyItemValue(doc, "ERRORMESSAGE", false);
		String emptyFlag = SMessageUtil.getBodyItemValue(doc, "EMPTYFLAG", false);
...
//    						if(sqlResult.get(i).get("EMAIL") != null && StringUtils.isNotEmpty((String) sqlResult.get(i).get("EMAIL")))
    		...
    		try
    		{
    			AlarmMailTemplate mailTemplateData = ExtendedObjectProxy.getAlarmMailTemplateService().selectByKey(false, new Object[]{"ERR", "*"});
    			...
    			try
    			{
        			...
        			title = title.replaceAll("!<ERRORMESSAGE>", errorMessage);
        			title = title.replaceAll("!<EMPTYFLAG>", emptyFlag);
        			...
        			contentTemp = contentTemp.replaceAll("!<ERRORMESSAGE>", errorMessage);
        			contentTemp = contentTemp.replaceAll("!<EMPTYFLAG>", emptyFlag);
    			}
    			catch(Exception ex)
    			{
