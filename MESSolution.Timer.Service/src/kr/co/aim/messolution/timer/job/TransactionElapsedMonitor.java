...
public class TransactionElapsedMonitor implements Job, InitializingBean, ApplicationContextAware {
	
	private static Log log = LogFactory.getLog(TransactionElapsedMonitor.class);
...
//		}
		...
		if(result != null && result.size() > 0)
		{
			...
			for (ListOrderedMap row : result)
			{
				...
				if(this.existErrorMessageInAlarmActionDef())
				{
					...
					this.sendEmail(eventInfo,eventName, serverName, eventUser, timeKey, transactionID, ip, elapsedTime);
				}
			}
		}
	}
	
	public void sendEmail(EventInfo eventInfo,String eventName, String serverName, String eventUser, String timeKey, String transactionID, String ip, String elapsedTime)
	{
    	try
    	{
	...
	public void createAlarmDefAndAction(String eventName)
	{
