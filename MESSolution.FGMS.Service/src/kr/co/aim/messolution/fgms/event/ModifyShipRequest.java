...
public class ModifyShipRequest extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ModifyShipRequest", getEventUser(), getEventComment(), "", "");
		...
		FGMSServiceProxy.getShipRequestService().updateShipRequest(eventInfo, shiprequestData.getInVoiceNo(), invoiceType,
				shiprequestData.getShipRequestState(), shiprequestData.getCreateTime(), shiprequestData.getCreateUser(),
				shiprequestData.getReserveTime(), shiprequestData.getReserveUser(), shiprequestData.getConfirmTime(),
				shiprequestData.getConfirmUser(), shiprequestData.getCompleteTime(), shiprequestData.getCompleteUser(),
				shiprequestData.getCancelTime(), shiprequestData.getCancelUser(),
