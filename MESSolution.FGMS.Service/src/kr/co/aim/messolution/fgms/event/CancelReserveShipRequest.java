...
public class CancelReserveShipRequest extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		String allWeight        = null;
		String pureWeight       = null;
		String volumn           = null;		
		String confirmUser      = getEventUser();      //SMessageUtil.getBodyItemValue(doc, "CONFIRMUSER", true);
		String lastEventName    = "CancelReserveShipRequest";//SMessageUtil.getBodyItemValue(doc, "LASTEVENTNAME", true);
...
//		//}
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CancelReserveShipRequest", getEventUser(), getEventComment(), "", "");
