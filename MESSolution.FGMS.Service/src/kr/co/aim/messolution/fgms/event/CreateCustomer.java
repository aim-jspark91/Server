...
public class CreateCustomer extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		try
		{
			...
			if (sqlResult.size() > 0)
				throw new CustomException("CUSTOMER-9001", customerNo);
		}
		catch (NotFoundSignal ne)
		{
			sqlResult = new ArrayList <Customer>();
		}
...
//			throw new CustomException("CUSTOMER-0001", fax);
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CreateCustomer", getEventUser(), getEventComment(), "", "");
		
		//execute
		FGMSServiceProxy.getCustomerService().create(eventInfo, customer);
