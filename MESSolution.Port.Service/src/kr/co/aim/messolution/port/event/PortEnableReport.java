...
public class PortEnableReport extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException {
        ...
        CommonValidation.checkStateName(portSpecData.getPortStateModelName(),GenericServiceProxy.getConstantMap().Port_UP);
        MakePortStateByStateInfo makePortStateByStateInfo = MESPortServiceProxy.getPortInfoUtil().makePortStateByStateInfo(portData, GenericServiceProxy.getConstantMap().Port_UP);
