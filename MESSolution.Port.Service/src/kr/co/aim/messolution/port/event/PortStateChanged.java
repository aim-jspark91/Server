...
public class PortStateChanged extends AsyncHandler {
    ...
    public void doWorks(Document doc) throws CustomException {
        ...
        PortSpec portSpecData = CommonUtil.getPortSpecInfo(machineName, portName);
        
        //add by wghuang 20181116
        MESPortServiceProxy.getPortServiceUtil().checkPortStateModelName(portSpecData, portName);
